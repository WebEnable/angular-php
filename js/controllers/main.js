...
angular.module('NileshTutorial')
  .controller('addTestCntrl', function ($scope) {
  });
angular.module('NileshTutorial')
...
angular.module('NileshTutorial')
  .controller('uploadAnswerSheet', function ($scope,$location,UserService,ClassSubject) {
...
angular.module('NileshTutorial')
  .controller('AnswerSheetList', function ($scope,$location,UserService,ClassSubject) {
